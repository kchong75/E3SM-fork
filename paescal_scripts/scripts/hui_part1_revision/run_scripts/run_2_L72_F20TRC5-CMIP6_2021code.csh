...
#====================================================================
   ...
   ./xmlchange -file env_build.xml    -id EXEROOT    -val $PTMP/bld_v1_${CCSMTAG}_${COMPSET}_${ntasks}tasks
...
./xmlchange  -file env_batch.xml -id JOB_WALLCLOCK_TIME -val '26:00:00'
...
! change init data
!...................
ncdata = '/pscratch/sd/h/huiwan/cflx/v1_papers/input/constance_FC5AV1C-04P2_ne30_ne30_E3SMv1.0_CLIMO_PD_TUNE.cam.i.0000-10-01-00000.nc'
/
EOF

cat <<EOB >! user_nl_clm
&clm_inparm
 finidat = '/pscratch/sd/h/huiwan/cflx/v1_papers/input/constance_FC5AV1C-04P2_ne30_ne30_E3SMv1.0_CLIMO_PD_TUNE.clm2.r.0000-10-01-00000.nc'
