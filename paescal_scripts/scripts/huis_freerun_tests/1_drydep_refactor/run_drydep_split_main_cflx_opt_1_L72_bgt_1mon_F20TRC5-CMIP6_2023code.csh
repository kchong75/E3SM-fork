...
setenv CASE     drydep_split_main_cflx_cpl_opt${cflx_cpl_opt}_bgt_${COMPSET}
...
#====================================================================
  ...
  #./xmlchange -file env_build.xml    -id EXEROOT    -val $PTMP/drydep_BLD2_$CCSMTAG
  #./xmlchange -file env_build.xml    -id EXEROOT    -val $PTMP/drydep_BLD3_$CCSMTAG
   ./xmlchange -file env_build.xml    -id EXEROOT    -val $PTMP/drydep_BLD5_$CCSMTAG
