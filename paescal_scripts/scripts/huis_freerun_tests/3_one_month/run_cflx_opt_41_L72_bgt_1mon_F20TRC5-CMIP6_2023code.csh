...
setenv MACH      compy
setenv PTMP      /compyfs/$user/scidac_scratch/2023_cflx/2023code/1mon

setenv ntasks 400
setenv nthrds 1

setenv CASE     opt${cflx_cpl_opt}_${COMPSET}

setenv CASEROOT  $PTMP/$CASE/case/$CASE
...
#====================================================================
   ...
   ./xmlchange -file env_build.xml    -id EXEROOT    -val $PTMP/cflx_BLD4x_$CCSMTAG
